...
@pytest.mark.parametrize(
    ...
    [
        ...
        (["PDrW", "PDrR", "PDrG", "PBa6"], "Ba4", RuleSlug.BIG_THREE_DRAGONS, 10),
        (["PWiE", "PWiW", "PWiN", "PBa6"], "WiS", RuleSlug.LITTLE_FOUR_WINDS, 10),
        (["PWiE", "PWiW", "PWiN", "PWiS"], "Ba6", RuleSlug.BIG_FOUR_WINDS, 10),
        (["PWiE", "PWiW", "PDrG", "PDrW"], "DrR", RuleSlug.ALL_HONORS, 10),
        (["PBa1", "PBa9", "PCi1", "PCh1"], "Ch9", RuleSlug.ALL_TERMINALS, 10),
    ],
)
